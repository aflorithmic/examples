...
| [SalesExample](https://github.com/aflorithmic/examples/blob/main/python/sales_example.py) <br/> A voicemail message with personalisation for names and various preferences. | ✨SalesOps  |
