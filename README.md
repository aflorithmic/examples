...
| [Voicemail](https://github.com/aflorithmic/examples/blob/main/python/voicemail.py) <br/> Combining the Genius and Aflorithmic API to generate your favourite song with our voice | Music |
